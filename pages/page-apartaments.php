    ...
    <div class="row px-0 apartament-filters-row">
        <section class="apartament-filters col-md-10 col-12 offset-md-1">
            ...
            <div class="apartaments-filters-view">
                <p>Tryb wyszukania</p>
                <button class="change-search-view active" data-view="apartaments-view-table">
                    Tabelka
                </button>
                <button class="change-search-view" data-view="apartaments-view-visual">
                    Wizualizacja
                </button>
            </div>
                    ...
                    <form class="filters w-100">
                        ...
                        <div class="filters__sliders">
                            ...
                            <div class="filters__sliders--item floors">
                                <p>Piętro</p>
                                <div class="filters__multi-range">
                                    <input type="range" min="<?php echo $min_floor ?>" max="<?php echo $max_floor; ?>"
                                        value="<?php echo $min_floor ?>" data-type="2" data-lower>
                                    <input type="range" min="<?php echo $min_floor ?>" max="<?php echo $max_floor; ?>"
                                        value="<?php echo $max_floor ?>" data-type="2" data-upper>
                            ...
                            <div class="filters__sliders--item rooms">
                                <p>Ilość pokoi</p>
                                <div class="filters__multi-range">
                                    <input type="range" min="<?php echo $min_room ?>" max="<?php echo $max_room; ?>"
                                        value="<?php echo $min_room ?>" data-type="1" data-lower>
                                    <input type="range" min="<?php echo $min_room ?>" max="<?php echo $max_room; ?>"
                                        value="<?php echo $max_room ?>" data-type="1" data-upper>
                                    <div class="filters__multi-range--lefty" data-min>
                                        <?php echo $min_room ?>
                                    </div>
                                    <div class="filters__multi-range--righty" data-max>
