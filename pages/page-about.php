...
<?php get_header('page'); ?>
    <main class="page-main">
        ...
        <img class="w-100" src="<?php echo $img ?>" alt="<?php echo $title ?>">
                    ...
                    <div class="wrapper">
                        <div class="row mx-0 px-0">
                            <div class="col-12 col-md-6 px-md-0 pe-md-5">
                                <div class="pe-md-4">
                                    <img class="w-100 mb-5" src="<?php echo $img_left ?>" alt="<?php echo $title_left ?>">
                            ...
                            <div class="col-12 col-md-6 px-md-0 ps-md-5">
                                <div class="ps-md-4">
                                    ...
                                    <img class="w-100 mt-5" src="<?php echo $img_right ?>" alt="<?php echo $text_right ?>">
                                </div>
                            </div>
                        </div>
                    </div>
