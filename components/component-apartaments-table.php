...
<table class="apartaments-list active mb-3" data-table>
    <caption></caption>
    <thead>
        <tr>
            <th><a data-meters_trigger data-type="0" href="#">
                    Powierzchnia
                    <!--                Hide on smaller -->
                    <!--                <span>[m2]</span>-->
                    <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 15">
                        <polygon id="b" points="21 0 24 3.06 12 15 0 3.06 3 0 12 9 21 0" />
                    </svg>
                </a>
            </th>
            <th>Piętro</th>
            <th>Pok.</th>
            <th>Cena m² / cena (netto) </th>
            <!--        <th>Cena netto</th>-->
            <th>Numer</th>
            <th>Status</th>
            <th>Rzut</th>
