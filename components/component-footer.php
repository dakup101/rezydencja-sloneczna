<footer>
    ...
    <section class="site-footer">
        ...
        <div class="site-footer__banner">
            <img src="<?php echo $banner ?>" alt="Słoneczna Rezydencja">
        </div>
        <div class="row mx-0 px-0 pt-5 pb-4">
            <div class="col-12 col-md-10 offset-md-1">
                <div class="site-footer__wrapper text-center">
                    <img src="<?php echo THEME_URI . '/assets/images/footer-logo.jpg' ?>" alt="Rezydencja Słoneczna">
                    <div class="row mt-5">
                    ...
                    <div class="site-footer__copyright mt-4 pt-4">
                        ...
                        <div class="site-footer__copyright--everywhere">
                            ...
                            <a class="site-footer__copyright--link" href="https://everywhere.pl/">
                                <img src="<?php echo THEME_URI.'/assets/images/everywhere.jpg' ?>" class="site-footer__copyright--img" alt="Created By: Everywhere Polska">
                            </a>
                        </div>
                    </div>
                </div>
