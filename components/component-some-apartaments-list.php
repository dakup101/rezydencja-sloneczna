    ...
    <div class="row mx-0 px-0">
        <div class="col-12 col-md-10 offset-md-1">
                            ...
                            <th><a data-meters_trigger
                                   ...
                                   href="#">
                                    ...
                                    <svg id="a"
                                         ...
                                         viewBox="0 0 24 15">
                                        <polygon id="b"
                                                 points="21 0 24 3.06 12 15 0 3.06 3 0 12 9 21 0" />
                                    </svg>
                                </a>
                            </th>
                            <th>Piętro</th>
            ...
            <div class="d-flex align-items-center justify-content-center mt-3">
                <a href="#"
                   class="button button__fill">Zobacz wszystkie apartamenty</a>
                <a href="#"
                   class="button button__stroke-accent">Skontaktuj się</a>
            </div>
        </div>
    </div>
</section>