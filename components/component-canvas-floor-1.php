<div style="position: fixed; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 2rem; color: white; cursor: pointer align-items: center; justify-content: center; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.3); z-index: 9999"
    ...
    <div class="canvas-item position-relative" style="width: 90%; max-width: 1400px">
        ...
        <a href="<?php echo THEME_DOC . '/A17.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 156.55 143.36">
                <g>
                    <polyline style="fill: #F0DEBC;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A16.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205.23 236.13">
                <g>
                    <polyline style="fill: #E7BB7A;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A15.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.82 238.11">
                <g>
                    <polyline style="fill: #F7E3E5;" class="cls-1"
                        points="0 238.11 0 0 184.82 0 184.82 238.11 0 238.11" />
                </g>
            </svg>
        </a>
        ...
        <!--         <a href="<?php echo THEME_DOC . '/A20.pdf' ?>" target="_blank"
           ...
           class="reserved"
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212.03 187.94"><g><polyline style="fill: #C0EDC4" class="cls-1" points="0 187.94 0 51.18 108.43 51.18 108.43 0 212.03 0 212.03 85.32 138.9 85.32 138.9 187.94 0 187.94"/></g></svg> -->
        </a>
        <a href="<?php echo THEME_DOC . '/A21.pdf' ?>" target="_blank"
            style="position: absolute; top: 20%; left: 50.5%; width: 15%; opacity: 30%" class="reserved">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212.03 187.94">
                <g>
                    <polyline style="fill: #FFCECF;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A22.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.82 231.02">
                <g>
                    <polyline style="fill: #F0DBFE" class="cls-1"
                        points="184.82 0 184.82 231.02 0 231.02 0 0 184.82 0" />
                </g>
            </svg>
        </a>
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205.23 231.02"><g><polyline style="fill: #B3FEF2" class="cls-1" points="205.23 94.11 205.23 182.83 134.93 182.83 134.93 183.4 129.83 183.4 45.59 183.4 45.59 231.02 0 231.02 0 183.4 0 0 134.93 0 134.93 94.11 205.23 94.11"/></g></svg>
        </a> -->
        <a href="<?php echo THEME_DOC . '/A24.pdf' ?>" target="_blank"
            style="position: absolute; top: 40.5%; left: 83.1%; width: 10.9%; opacity: 30%">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 156.55 143.36">
                <g>
                    <polyline style="fill: #72CE90;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A25.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205.23 236.13">
                <g>
                    <polyline style="fill: #DAE4E9" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A26.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.82 238.11">
                <g>
                    <polyline style="fill: #B8B7FC" class="cls-1"
                        points="0 238.11 0 0 184.82 0 184.82 238.11 0 238.11" />
                </g>
            </svg>
        </a>
