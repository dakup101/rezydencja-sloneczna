<div style="position: fixed; display: flex; flex-direction: column; color: white; align-items: center; justify-content: center; gap: 2rem; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.3); z-index: 9999"
    ...
    <div class="canvas-item position-relative" style="width: 90%; max-width: 1400px">
        ...
        <a href="<?php echo THEME_DOC . '/A32.pdf' ?>" target="_blank"
            style="position: absolute; top: 12%; left: 5.7%; width: 14.6%; opacity: 30%" class="reserved">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205.23 231.02">
                <g>
                    <polyline style="fill: #FFFFD6" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A31.pdf' ?>" target="_blank"
            style="position: absolute; top: 39.5%; left: 5.7%; width: 10.9%; opacity: 30%" class="reserved">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 161.05 248.67">
                <g>
                    <polygon style="fill: #F0DEBC" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A30.pdf' ?>" target="_blank"
            style="position: absolute; top: 54%; left: 10.8%; width: 15.9%; opacity: 30%" class="reserved">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 228.75 249.27">
                <g>
                    <polygon style="fill: #E7BB7A;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A29.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.81 249.27">
                <g>
                    <polygon style="fill: #F7E3E5;" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A33.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.82 231.02">
                <g>
                    <polyline style="fill: #B5EAEA;" class="cls-1"
                        points="184.82 0 184.82 231.02 0 231.02 0 0 184.82 0" />
                </g>
            </svg>
        </a>
        <a href="<?php echo THEME_DOC . '/A34.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212.03 187.94">
                <g>
                    <polyline style="fill: #C0EDC4" class="cls-1"
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212.03 187.94"><g><polyline style="fill: #FFCECF" class="cls-1" points="212.03 187.94 73.13 187.94 73.13 85.32 0 85.32 0 0 103.61 0 103.61 51.18 212.03 51.18 212.03 187.94"/></g></svg>
        </a> -->
        <!--         <a href="<?php echo THEME_DOC . '/A36.pdf' ?>" target="_blank"
           style="position: absolute; top: 12%; left: 65.8%; width: 13%; opacity: 30%"
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.82 231.02"><g><polyline style="fill: #F0DBFE" class="cls-1" points="184.82 0 184.82 231.02 0 231.02 0 0 184.82 0"/></g></svg>
        </a> -->
        <a href="<?php echo THEME_DOC . '/APARTAMENT-A37.pdf' ?>" target="_blank"
            style="position: absolute; top: 12%; left: 79.6%; width: 14.5%; opacity: 30%" class="reserved">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205.23 231.02">
                <g>
                    <polyline style="fill: #B3FEF2" class="cls-1"
        ...
        <!--         <a href="<?php echo THEME_DOC . '/APARTAMENT-A38.pdf' ?>" target="_blank"
           ...
           class="reserved"
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 162.03 248.33"><g><polygon style="fill: #72CE90" class="cls-1" points="0 146.11 0 0 162.03 0 162.03 248.33 91.58 248.33 91.58 146.38 0 146.11"/></g></svg>
        </a> -->
        <a href="<?php echo THEME_DOC . '/A39.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234.54 240.51">
                <g>
                    <polygon style="fill: #DAE4E9" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A40.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.81 249.27" style="transform: scale(-1,1)">
                <g>
                    <polygon style="fill: #B8B7FC;" class="cls-1"
                        points=".23 152.05 88.73 152.05 88.73 249.27 192.81 249.27 192.81 0 0 0 .23 152.05" />
                </g>
            </svg>
        </a>
        <a href="<?php echo THEME_DOC . '/A41.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 195.59 193.61">
                <g>
                    <polyline style="fill: #6FB9B9" class="cls-1"
        ...
        <a href="<?php echo THEME_DOC . '/A28.pdf' ?>" target="_blank"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 230.93 193.61">
                <g>
                    <polyline style="fill: #FFB8FD" class="cls-1"
